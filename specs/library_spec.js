...
describe('Library', function () {
  ...
  //   ];
  //   const libraryWithBooks = new Library(books);
  //   const titlesPlusAuthors = ['The Fellowship of the Ring by J R R Tolkien', 'The Two Towers by J R R Tolkien', 'The Return of the King by J R R Tolkien']
  //   assert.strictEqual(libraryWithBooks.printInventory(), titlesPlusAuthors);
  // });
});
